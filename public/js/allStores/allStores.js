...
ebates.stats.targetPage = decodeURIComponent("/stores/all/index.htm");
function FBCbebform1585347760010(response) {
    var formDiv = document.getElementById('eb-form-1585347760010'), suParams,
...
function updateFBUI() {
    FB.getLoginStatus(function (r) {
        ...
        fb_btn_new = '<div class="ht-50 pos-abs fb-custom-btn"><div class="round3 fb-login-button ht-40 mar-10-b" data-onlogin="FBCbebform1585347760010" data-scope="public_profile,email" data-width="' + fb_btn_width + '" data-max-rows="1" data-size="large" data-button-type="continue_with" data-show-faces="false" data-auto-logout-link="false" data-use-continue-as="true"></div><div id="fb-join-fac" class="pos-abs pointer ht-40" style="left:365px;width:294px;margin-top:-50px"></div></div>';
...
ebates.form.opts["All-Stores-Walmart-Hero-201510"] = {
    captcha: {
        cb: function () {
...
ebates.js.require(ebates.src.form.factory, function () {
    setTimeout(function () {
        var theForm = document.getElementById("eb-form-1585347760010"),
            urlIdField, GOOGLE_SDK = 'https://apis.google.com/js/api.js';
        if (theForm) {
            ebates.form.init.bind(theForm, ebates.form.opts["All-Stores-Walmart-Hero-201510"])();
            urlIdField = theForm.querySelector("input[name=urlIdentifier]");
            urlIdField && (urlIdField.value = location.pathname + location.search + "|" + "All-Stores-Walmart-Hero-201510" + ("" ? " - " : ""));
